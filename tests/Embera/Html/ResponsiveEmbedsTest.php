...
class ResponsiveEmbedsTest extends TestCase
{
    ...
    public function testBasicYoutubeResponse()
    {
        ...
        $expected = '<div class="embera-embed-responsive embera-embed-responsive-video"><iframe class="embera-embed-responsive-item-video" src="https://www.youtube.com/embed/ovpVWuuUgJg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
        $response = [
            'type' => 'video',
            'embera_provider_name' => 'Youtube',
            'html' => $html,
    ...
    public function testAdvancedYoutubeResponse()
    {
        ...
        $expected = '<div class="embera-embed-responsive embera-embed-responsive-video"><iframe class="example embera-embed-responsive-item-video" src="https://www.youtube.com/embed/ovpVWuuUgJg" frameborder="0" style="margin:0;" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
        $response = [
            'type' => 'video',
            'embera_provider_name' => 'Youtube',
            'html' => $html,
